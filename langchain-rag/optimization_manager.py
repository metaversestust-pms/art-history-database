    ...
    async def batch_process(self, queries: List[str], process_func) -> List[Any]:
        ...
        for query in queries:
            task = asyncio.create_task(
                self.process_query(process_func, query)
            )
            tasks.append(task)
...
class OptimizationManager:
    ...
    def _update_metrics(self, response_time: float):
        ...
        self.performance_metrics['avg_response_time'] = \
            np.mean(self.performance_metrics['response_times'])
    ...
    def get_optimization_stats(self) -> Dict[str, Any]:
        ...
        if self.performance_metrics['response_times']:
            stats['performance_metrics']['p95_response_time'] = \
                np.percentile(self.performance_metrics['response_times'], 95)
            stats['performance_metrics']['p99_response_time'] = \
                np.percentile(self.performance_metrics['response_times'], 99)
