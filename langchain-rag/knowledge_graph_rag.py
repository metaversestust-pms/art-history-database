...
from multimodal_rag import ArtHistoryEmbeddings, MultimodalRetriever
...
class ArtHistoryGraphRetriever(BaseRetriever):
    ...
    def _convert_graph_result_to_documents(self, result: GraphQueryResult,
...
class HybridKnowledgeGraphRAG:
    ...
    def enhanced_query(self, query: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'graph_relationships': len([d for d in graph_docs if d.metadata.get('relationship_type')]),
