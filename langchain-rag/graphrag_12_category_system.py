...
class GraphRAGQueryRouter:
    ...
    def _build_category_mappings(self) -> Dict[ArtHistory12Categories, List[DetailedNodeTypes]]:
        ...
        return {
            ArtHistory12Categories.PEOPLE: [
                DetailedNodeTypes.ARTIST, DetailedNodeTypes.THEORIST,
                DetailedNodeTypes.PATRON, DetailedNodeTypes.COLLECTOR,
                DetailedNodeTypes.WORKSHOP_MASTER, DetailedNodeTypes.CRITIC
            ],
            ArtHistory12Categories.ARTWORKS: [
                DetailedNodeTypes.PAINTING, DetailedNodeTypes.SCULPTURE,
                DetailedNodeTypes.ARCHITECTURE, DetailedNodeTypes.MANUSCRIPT,
                DetailedNodeTypes.PRINT, DetailedNodeTypes.DRAWING
            ],
            ArtHistory12Categories.MOVEMENTS: [
                DetailedNodeTypes.EARLY_RENAISSANCE, DetailedNodeTypes.HIGH_RENAISSANCE,
                DetailedNodeTypes.LATE_RENAISSANCE, DetailedNodeTypes.MANNERISM,
                DetailedNodeTypes.BAROQUE, DetailedNodeTypes.NEOCLASSICISM
            ],
            ArtHistory12Categories.TECHNIQUES: [
                DetailedNodeTypes.OIL_PAINTING, DetailedNodeTypes.TEMPERA,
                DetailedNodeTypes.FRESCO, DetailedNodeTypes.WET_FRESCO,
                DetailedNodeTypes.MARBLE_CARVING, DetailedNodeTypes.BRONZE_CASTING
            ],
            ArtHistory12Categories.THEMES: [
                DetailedNodeTypes.RELIGIOUS_MOTIF, DetailedNodeTypes.MYTHOLOGY,
                DetailedNodeTypes.PORTRAIT, DetailedNodeTypes.ALLEGORY,
                DetailedNodeTypes.LANDSCAPE, DetailedNodeTypes.STILL_LIFE
            ],
            ArtHistory12Categories.CHRONOLOGY: [
                DetailedNodeTypes.CENTURY, DetailedNodeTypes.EPOCH,
                DetailedNodeTypes.DYNASTY, DetailedNodeTypes.MEDICI_PERIOD,
                DetailedNodeTypes.PAPAL_PERIOD
            ],
            ArtHistory12Categories.PLACES: [
                DetailedNodeTypes.CITY, DetailedNodeTypes.REGION,
                DetailedNodeTypes.CHURCH, DetailedNodeTypes.PALACE,
                DetailedNodeTypes.MUSEUM, DetailedNodeTypes.ARCHAEOLOGICAL_SITE
            ],
            ArtHistory12Categories.INSTITUTIONS: [
                DetailedNodeTypes.GUILD, DetailedNodeTypes.PATRONAGE_FAMILY,
                DetailedNodeTypes.ACADEMY, DetailedNodeTypes.COLLECTION_INSTITUTION,
                DetailedNodeTypes.WORKSHOP
            ],
            ArtHistory12Categories.EVENTS: [
                DetailedNodeTypes.COMMISSION, DetailedNodeTypes.EXHIBITION,
                DetailedNodeTypes.RELOCATION, DetailedNodeTypes.RESTORATION,
                DetailedNodeTypes.PUBLICATION, DetailedNodeTypes.CONTROVERSY
            ],
            ArtHistory12Categories.SOURCES: [
                DetailedNodeTypes.VASARI_LIVES, DetailedNodeTypes.PRIMARY_SOURCE,
                DetailedNodeTypes.CATALOG_RAISONNE, DetailedNodeTypes.RESEARCH_PAPER,
                DetailedNodeTypes.EXHIBITION_CATALOG
            ],
            ArtHistory12Categories.CONCEPTS: [
                DetailedNodeTypes.PERSPECTIVE, DetailedNodeTypes.SFUMATO,
                DetailedNodeTypes.CONTRAPPOSTO, DetailedNodeTypes.CHIAROSCURO,
                DetailedNodeTypes.DISEGNO, DetailedNodeTypes.COLORITO
            ],
            ArtHistory12Categories.TRANSLATIONS: [
                DetailedNodeTypes.ITALIAN_TERM, DetailedNodeTypes.ENGLISH_TERM,
                DetailedNodeTypes.CHINESE_TERM, DetailedNodeTypes.ALTERNATIVE_NAME,
    ...
    def _define_query_patterns(self) -> Dict[str, Dict]:
        ...
        return {
            ...
            "artwork_analysis": {
                ...
                "target_categories": [
                    ArtHistory12Categories.PEOPLE, ArtHistory12Categories.TECHNIQUES,
                    ArtHistory12Categories.THEMES, ArtHistory12Categories.PLACES
                ],
                "key_relations": [
                    GraphRAGRelationTypes.CREATED_BY, GraphRAGRelationTypes.USES_TECHNIQUE,
                    GraphRAGRelationTypes.DEPICTS, GraphRAGRelationTypes.HOUSED_IN
                ],
                "expansion_depth": 3,
            ...
            "movement_exploration": {
                ...
                "target_categories": [
                    ArtHistory12Categories.PEOPLE, ArtHistory12Categories.ARTWORKS,
                    ArtHistory12Categories.CHRONOLOGY, ArtHistory12Categories.PLACES
                ],
                "key_relations": [
                    GraphRAGRelationTypes.BELONGS_TO_MOVEMENT, GraphRAGRelationTypes.ACTIVE_DURING,
            ...
            "technique_study": {
                ...
                "key_relations": [
                    GraphRAGRelationTypes.USES_TECHNIQUE, GraphRAGRelationTypes.CREATED_BY
                ],
                "expansion_depth": 2,
            ...
            "geographic_cultural": {
                ...
                "target_categories": [
                    ArtHistory12Categories.PEOPLE, ArtHistory12Categories.ARTWORKS,
                    ArtHistory12Categories.INSTITUTIONS, ArtHistory12Categories.MOVEMENTS
                ],
                "key_relations": [
                    GraphRAGRelationTypes.LOCATED_IN, GraphRAGRelationTypes.BORN_IN,
                    GraphRAGRelationTypes.WORKED_IN, GraphRAGRelationTypes.HOUSED_IN
                ],
                "expansion_depth": 3,
            ...
            "temporal_context": {
                ...
                "target_categories": [
                    ArtHistory12Categories.PEOPLE, ArtHistory12Categories.ARTWORKS,
                    ArtHistory12Categories.MOVEMENTS, ArtHistory12Categories.EVENTS
                ],
                "key_relations": [
                    GraphRAGRelationTypes.ACTIVE_DURING, GraphRAGRelationTypes.CREATED_DURING
                ],
                "expansion_depth": 2,
            ...
            "terminology_mapping": {
                ...
                "target_categories": [
                    ArtHistory12Categories.CONCEPTS, ArtHistory12Categories.TECHNIQUES
                ],
                "key_relations": [
                    GraphRAGRelationTypes.TRANSLATED_AS, GraphRAGRelationTypes.EQUIVALENT_TO,
    ...
    def analyze_query_intent(self, query: str) -> Dict[str, Any]:
        ...
        # 關鍵詞檢測
        category_keywords = {
            ArtHistory12Categories.PEOPLE: ["藝術家", "達文西", "米開朗基羅", "拉斐爾", "artist", "leonardo", "michelangelo"],
            ArtHistory12Categories.ARTWORKS: ["作品", "繪畫", "雕塑", "蒙娜麗莎", "painting", "sculpture", "mona lisa"],
            ArtHistory12Categories.MOVEMENTS: ["文藝復興", "巴洛克", "renaissance", "baroque", "mannerism"],
            ArtHistory12Categories.TECHNIQUES: ["油彩", "濕壁畫", "技法", "oil painting", "fresco", "technique"],
            ArtHistory12Categories.THEMES: ["主題", "宗教", "神話", "肖像", "theme", "religious", "portrait"],
            ArtHistory12Categories.CHRONOLOGY: ["時期", "世紀", "美第奇", "period", "century", "medici"],
            ArtHistory12Categories.PLACES: ["佛羅倫斯", "羅馬", "博物館", "florence", "rome", "museum"],
            ArtHistory12Categories.INSTITUTIONS: ["學院", "工坊", "行會", "academy", "workshop", "guild"],
            ArtHistory12Categories.EVENTS: ["委託", "展覽", "修復", "commission", "exhibition", "restoration"],
            ArtHistory12Categories.SOURCES: ["文獻", "瓦薩里", "研究", "vasari", "source", "research"],
            ArtHistory12Categories.CONCEPTS: ["透視", "暈塗法", "perspective", "sfumato", "chiaroscuro"],
            ArtHistory12Categories.TRANSLATIONS: ["義大利語", "英文", "中文", "翻譯", "italian", "translation"]
        }
        ...
        return {
            ...
            "confidence": len(detected_categories) / len(category_keywords) if detected_categories else 0.1
        }
