...
class PerformanceBenchmark:
    ...
    async def test_enhanced_system(self):
        ...
        for i, query in enumerate(self.test_queries, 1):
            ...
            print(f"  查詢 {i}: {response_time:.3f}s | {strategy_name} | 準確度: {simulated_accuracy:.2f}")
    ...
    async def test_baseline_system(self):
        ...
        for i, query in enumerate(self.test_queries, 1):
            ...
            print(f"  查詢 {i}: {response_time:.3f}s | hybrid_balanced | 準確度: {simulated_accuracy:.2f}")
    ...
    def compare_performance(self, enhanced_metrics: Dict, baseline_metrics: Dict):
        ...
        accuracy_improvement = ((enhanced_avg_accuracy - baseline_avg_accuracy) / baseline_avg_accuracy) * 100
        ...
        # 成功率對比
        enhanced_success_rate = enhanced_metrics['successful_queries'] / enhanced_metrics['total_queries']
        baseline_success_rate = baseline_metrics['successful_queries'] / baseline_metrics['total_queries']
        success_improvement = ((enhanced_success_rate - baseline_success_rate) / baseline_success_rate) * 100
    ...
    def generate_performance_report(self, enhanced_metrics: Dict, baseline_metrics: Dict):
        ...
        report = {
            ...
            'enhanced_system_results': {
                ...
                'success_rate': enhanced_metrics['successful_queries'] / enhanced_metrics['total_queries'],
            ...
            'baseline_system_results': {
                ...
                'success_rate': baseline_metrics['successful_queries'] / baseline_metrics['total_queries'],
            ...
            'performance_improvements': {
                'response_time_improvement': ((statistics.mean(baseline_metrics['response_times']) -
                                             statistics.mean(enhanced_metrics['response_times'])) /
                                             statistics.mean(baseline_metrics['response_times'])) * 100,
                'accuracy_improvement': ((statistics.mean(enhanced_metrics['accuracy_scores']) -
                                        statistics.mean(baseline_metrics['accuracy_scores'])) /
                                        statistics.mean(baseline_metrics['accuracy_scores'])) * 100,
                'success_rate_improvement': ((enhanced_metrics['successful_queries'] / enhanced_metrics['total_queries'] -
                                            baseline_metrics['successful_queries'] / baseline_metrics['total_queries']) /
                                            (baseline_metrics['successful_queries'] / baseline_metrics['total_queries'])) * 100
            }
        }
        ...
        # 輸出關鍵結論
        print(f"\n🎉 基準測試結論:")
        print(f"✅ 響應時間提升: {report['performance_improvements']['response_time_improvement']:+.1f}%")
        print(f"✅ 準確度提升: {report['performance_improvements']['accuracy_improvement']:+.1f}%")
        print(f"✅ 成功率提升: {report['performance_improvements']['success_rate_improvement']:+.1f}%")
