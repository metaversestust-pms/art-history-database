...
class ArtHistoryGraphBuilder:
    ...
    def build_relationships(self):
        ...
        relationships = [
            ...
            (
                ...
                "BELONGS_TO_MOVEMENT",
                "Renaissance",
                {"involvement_level": "Founding figure"},
            ),
            (
                "Michelangelo Buonarroti",
                "BELONGS_TO_MOVEMENT",
                "Renaissance",
                {"involvement_level": "Master"},
            ),
            (
                "Claude Monet",
                "BELONGS_TO_MOVEMENT",
                "Impressionism",
                {"involvement_level": "Founder"},
            ),
            (
                "Vincent van Gogh",
                "BELONGS_TO_MOVEMENT",
                "Post-Impressionism",
                {"involvement_level": "Key figure"},
            ),
            ...
            (
                ...
                "INFLUENCED_BY",
                "Vincent van Gogh",
                {"influence_type": "Color and expression"},
            ),
            (
                "Claude Monet",
                "INFLUENCED_BY",
                "Leonardo da Vinci",
                {"influence_type": "Light studies"},
            ),
            # 運動發展關係
            (
                "Post-Impressionism",
                "DEVELOPED_FROM",
                "Impressionism",
                {"development_type": "Reaction and evolution"},
            ),
        ]
    ...
    def save_to_files(self):
        ...
        # 保存實體數據
        entities_data = [
            {"type": entity.entity_type, "name": entity.name, "properties": entity.properties}
            for entity in self.entities
        ]
