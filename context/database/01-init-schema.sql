...
CREATE TABLE document_vectors (
    ...
    embedding TEXT, -- 暫時用TEXT存儲向量數據，之後可升級為pgvector
...
-- 提示完成
-- COMMENT ON DATABASE art_history_db IS '藝術史資料庫 - 支援RAG系統的完整藝術史資料架構';

-- 顯示初始化完成信息
DO $$
BEGIN
    RAISE NOTICE '==============================================';
    RAISE NOTICE '藝術史資料庫初始化完成';
    RAISE NOTICE '已創建 % 個表', (SELECT COUNT(*) FROM pg_tables WHERE schemaname = 'public');
    RAISE NOTICE '==============================================';
END $$;