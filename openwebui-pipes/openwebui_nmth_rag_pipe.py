...
version: 1.0.0
description: 透過 rag-manager-v2 (Neo4j + ChromaDB) 檢索藝術史/文物知識庫並回答問題
"""
...
class Pipe:
    class Valves(BaseModel):
        ...
        MODEL_COMBINATION_ID: str = Field(
            ...
            description="格式為 '{ollama模型}@{rag策略}'，可選策略見 /api/v1/strategies",
        )
    ...
    def __init__(self):
        self.id = "nmth_art_history_rag"
        self.name = "qwen3 8B + 臺灣歷史博物館 RAG"
