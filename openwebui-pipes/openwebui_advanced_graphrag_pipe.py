...
version: 1.0.0
description: 查詢改寫(術語正規化) + 多跳圖檢索(2-hop：風格/材質/技法/產地/機構/主題/概念) + 子圖重排序
"""
...
class Pipe:
    class Valves(BaseModel):
        ...
        MODEL_COMBINATION_ID: str = Field(
            default="qwen3:8b@advanced_graph_rag",
            description="格式為 '{ollama模型}@advanced_graph_rag'",
        )
