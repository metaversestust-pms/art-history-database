...
version: 1.0.0
description: 最基礎的圖譜檢索：關鍵詞比對 + 單跳關係展開，不做查詢改寫、重排序或多輪推理
"""
...
class Pipe:
    class Valves(BaseModel):
        ...
        MODEL_COMBINATION_ID: str = Field(
            default="qwen3:8b@naive_graph_rag",
            description="格式為 '{ollama模型}@naive_graph_rag'",
        )
    ...
    def __init__(self):
        self.id = "naive_graphrag"
        self.name = "qwen3 8B + Naive RAG"
