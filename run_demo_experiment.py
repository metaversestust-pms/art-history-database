...
async def run_demo():
    ...
    try:
        ...
        if summary.get('total_experiments', 0) > 0:
            success_rate = summary.get('successful_experiments', 0) / summary.get('total_experiments', 1) * 100
        ...
        if phase_results:
            ...
            for phase in phase_results:
                print(f"   {phase['phase']}: {phase['successful_experiments']}/{phase['total_experiments']} 成功")
