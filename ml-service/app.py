...
class ArtClassificationModel(nn.Module):
    ...
    def __init__(self, model_name='bert-base-multilingual-cased', num_periods=6,
                 num_styles=20, num_regions=5, num_mediums=10):
...
def start_training():
    ...
    try:
        ...
        # 估算訓練時間（簡化版本）
        estimated_time = len(training_data) * config.get('epochs', 10) * 0.1  # 每個樣本每個epoch約0.1秒
